...
void CGLKView::OnKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags)
{
	...
	{
	case VK_F1:
		m_glRenderer.svetlo1 = !m_glRenderer.svetlo1;
		break;
	case VK_F2:
		m_glRenderer.svetlo2 = !m_glRenderer.svetlo2;
		break;
	case VK_F3:
		m_glRenderer.svetlo3 = !m_glRenderer.svetlo3;
		break;
	case VK_F4:
		m_glRenderer.normale = !m_glRenderer.normale;
	default:
		break;
	}
